...
<body style="height: 100%;">
                                    ...
                                    <div class="card-body">                                        
                                        <form method="post" action="Login">
                                            ...
                                            <div class="form-group" style="color: #000000">
                                                ...
                                                <input type="submit" value="Login" class="btn float-center login_btn" style="margin-top: -90px ; background-color: #1C3D86; margin-left: 36%" onclick="display()">
                                            <div class="d-flex links">
                                            	<a href="privacy.jsp" style="color: #1C3D86; margin-left: 130px; margin-top: -30px ;">Login as Admin</a>
                                      	  	</div>
                                            </div>
                                        </form>
                                    </div>
   ...
   <footer class="page-footer dark" style= "background-color: #BFC9E1; margin-top: 110px; height: 200px;">
        <div class="container">
            <div class="row"
